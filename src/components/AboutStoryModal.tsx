...
import { X, Mail, Compass, ExternalLink } from 'lucide-react';
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14">
            ...
            <div className="lg:col-span-5 space-y-4 sm:space-y-6">
              {/* Kelsey Portrait (Fully responsive scaling) */}
              <div className="relative group max-w-sm sm:max-w-md lg:max-w-none mx-auto">
                <div className="overflow-hidden rounded-2xl bg-white/[0.02]">
                  <img
                    src="/portrait.webp"
                    alt="Kelsey Lin"
                    className="w-full h-[260px] sm:h-[340px] lg:h-[420px] object-cover object-top filter grayscale contrast-110 brightness-95 group-hover:grayscale-0 transition-all duration-700 ease-out"
                  />
                </div>
                <div className="absolute bottom-3 left-3 px-3 py-1 rounded-full bg-black/80 backdrop-blur-md text-[8px] sm:text-[9px] font-mono tracking-[0.18em] text-[#D8ECF8] uppercase shadow-md">
                  KELSEY LIN · UNIVERSITY OF MICHIGAN
                </div>
              </div>

              {/* Personal Manifesto Quote */}
              <div className="pl-4 py-2 bg-white/[0.02] rounded-r-xl max-w-sm sm:max-w-md lg:max-w-none mx-auto">
            ...
            <div className="lg:col-span-7 space-y-6 sm:space-y-7 pr-0 lg:pr-2">
              <div>
                <h1 className="font-syne text-2xl sm:text-4xl lg:text-5xl text-white font-bold leading-[1.12] sm:leading-[1.05] tracking-tight mb-4 sm:mb-6">
                  Building products with empathy, <br />
              ...
              <div className="space-y-4 sm:space-y-5 text-xs sm:text-sm font-sans text-[#D8ECF8]/85 font-light leading-relaxed">
                <div>
                  <h3 className="font-mono text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-[#FF5500] font-semibold mb-1.5">
                    01 // Learning to listen and observe
                  </h3>
                  <p>
                ...
                <div>
                  <h3 className="font-mono text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-[#FFAA00] font-semibold mb-1.5">
                    03 // Craft, discipline, and community
                  </h3>
                  <p>
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2 sm:pt-4">
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full bg-white text-black font-mono text-[11px] sm:text-xs font-semibold uppercase tracking-[0.2em] hover:bg-[#FFAA00] transition-colors"
                >
